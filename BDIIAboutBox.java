...
public class BDIIAboutBox extends javax.swing.JDialog {

    public BDIIAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        ResourceMap resourceMap = Application.getInstance().getContext().getResourceMap(BDIIAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = Application.getInstance().getContext().getActionMap(BDIIAboutBox.class, this);
